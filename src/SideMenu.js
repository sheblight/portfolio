    ...
    return (
        <nav className="side-menu">
            ...
            <footer style={{width: "230px", color: "var(--text-color)"}}>
                <a href="mailto:sheblight@gmail.com" style={{fontFamily: "var(--header-font)", textDecoration: "none", color: "var(--text-color)", letterSpacing: "1px", fontSize: "1rem"}}>sheblight@gmail.com</a>
                <div className="external-icons" style={{display: "flex", height: "50px", justifyContent: "flex-end", alignItems: "center", gap: "1rem"}}>
                ...
                <p style={{fontFamily: "var(--header-font)", fontSize: "1rem"}}>© 2023 Hibiki Takaku</p>
            </footer>
        </nav>
    );
  }
